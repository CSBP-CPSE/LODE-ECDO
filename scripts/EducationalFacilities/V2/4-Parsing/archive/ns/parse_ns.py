...
df1 = pd.read_csv("/home/jovyan/data-vol-1/opentabulate/data/output/ns/directoryofpublicschools2019-2020_isced.csv")
df2 = pd.read_csv("/home/jovyan/data-vol-1/opentabulate/data/output/ns/Recognized_Private_Schools_Granting_the_Nova_Scotia_High_School_Leaving_Certificate_isced.csv")
...
df.to_csv('ns_parsed.csv',index=False)
