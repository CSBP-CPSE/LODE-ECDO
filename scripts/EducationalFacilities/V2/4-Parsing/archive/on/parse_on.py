...
df1=pd.read_csv("/home/jovyan/data-vol-1/opentabulate/data/output/on/new_sif_data_table_2018_2019prelim_en_september_isced.csv")
df2=pd.read_csv("/home/jovyan/data-vol-1/opentabulate/data/output/on/on_private_schools_contact_information_october_2020_en_isced.csv")
...
df.to_csv('on_parsed.csv',index=False)
