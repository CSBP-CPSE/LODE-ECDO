...
f_dir = "/home/jovyan/data-vol-1/opentabulate/data/output/esdc"
flist = [f for f in listdir(f_dir) if f.endswith('.csv')]
files=["/home/jovyan/data-vol-1/opentabulate/data/output/esdc/{}".format(i) for i in flist]
...
df.to_csv('esdc_parsed.csv',index=False)
